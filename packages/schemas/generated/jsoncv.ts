...
export const JsonCv = z
  .object({
    $schema: z
      .string()
      .url()
      .describe("link to the version of the schema that can validate the CV")
      .optional(),
    basics: z
      .object({
      ...
      .array(
        z
          .object({
            ...
            date: z.string().date().describe("e.g. 1989-06-12").optional(),
        ...
        z
          .object({
            ...
            summary: z
              .string()
              .describe(
                "e.g. Expert level proficiency in web development with extensive knowledge and experience in multiple programming languages, frameworks and web technologies.",
              )
              .optional(),
            keywords: z
        ...
        z
          .object({
            ...
            summary: z
              .string()
              .describe(
                "e.g. Proficient in English with a pretty good level of speaking, writing and comprehension abilities.",
              )
              .optional(),
          })
          .catchall(z.any()),
    ...
    sideProjects: z
      ...
      .describe("Specify side projects")
      .optional(),
    meta: z
      .object({
        name: z
          .string()
          .describe(
            "The name of this JSONCV data, will be used as part of the filename when downloading.",
          )
          .optional(),
        canonical: z
          .string()
  ...
  .strict();
export type JsonCv = z.infer<typeof JsonCv>;
